...
class SettingFragment : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        btn_logout.setOnClickListener {
            AlertDialog.Builder(parentContext).setTitle("退出").setMessage(getString(R.string.tips_logout)).setPositiveButton(context!!.getString(R.string.yes), { _, i ->
    ...
    private fun initView() {
        ...
        if(rootview!=null) {
            ...
            rootview!!.checkSign(GlobalVar.LOCAL_USER!!.Uid)
        }
    }
